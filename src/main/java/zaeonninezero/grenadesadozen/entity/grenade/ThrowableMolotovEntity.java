...
{
    protected float radius = GrenadesConfig.COMMON.molotovExplosionRadius.get().floatValue();
    protected int fireDuration = GrenadesConfig.COMMON.molotovFireDuration.get();
